...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(MainActivity context, List<Task> taskList,  CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener, RecyclerView taskRecycler) {
        ...
        itemTouchHelper = new ItemTouchHelper(new SimpleItemTouchHelperCallback());
    ...
    private class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
            // Not used in this case since swipe-to-dismiss is disabled
        }
    }
